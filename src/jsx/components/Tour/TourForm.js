...
export default function UserForm() {
	...
	const handleCreate = (e) => {
		...
		for (let i = 0; i < detail.jurusan.length; i++) {
			...
			data.append(`jurusan[${i}][keberangkatan]`, detail.jurusan[i].keberangkatan);
			data.append(`jurusan[${i}][jam_keberangkatan]`, detail.jurusan[i].jam_keberangkatan);
			data.append(`jurusan[${i}][tujuan]`, detail.jurusan[i].tujuan);
			data.append(`jurusan[${i}][estimasi_sampai]`, detail.jurusan[i].estimasi_sampai);
		}
		createTour(data)
			.then(() => {
				setIsLoading(false);
	...
	const handleUpdate = (e) => {
		...
		for (let i = 0; i < detail.jurusan.length; i++) {
			...
			data.append(`jurusan[${i}][harga]`, detail.jurusan[i].harga);
			data.append(`jurusan[${i}][thumbnail]`, detail.jurusan[i].thumbnail);
			if (detail.jurusan[i].thumbnail !== '') data.append('jurusan[${i}][thumbnail]', detail.jurusan[i].thumbnail);
			data.append(`jurusan[${i}][keberangkatan]`, detail.jurusan[i].keberangkatan);
			data.append(`jurusan[${i}][jam_keberangkatan]`, detail.jurusan[i].jam_keberangkatan);
			data.append(`jurusan[${i}][tujuan]`, detail.jurusan[i].tujuan);
			data.append(`jurusan[${i}][estimasi_sampai]`, detail.jurusan[i].estimasi_sampai);
