										...
										<div className="row">
											<div className="mb-3 form-group">
												...
												{inputMerchant.thumbnail != "" && (
													<img
														src={URL.createObjectURL(inputMerchant.thumbnail)}
														alt="banner"
														className="border border-2 img-fluid border-dark rounded-3"
														style={{
															width: "40%",
