                          ...
                          <tr role="row" className="odd">
                            <td>
                              <div className="guest-bx">
                                ...
                                <div>
                                  <span className="text-primary"><i class="fa fa-map-marker"></i> Arcamanik, Ciletuh</span>
                          ...
                          <tr className="even">
                            <td>
                              <div className="guest-bx">
                                ...
                                <div>
                                  <span className="text-primary"><i class="fa fa-map-marker"></i> Antapani, Ciletuh</span>
                          ...
                          <tr className="odd">
                            <td>
                              <div className="guest-bx">
                                ...
                                <div>
                                  <span className="text-primary"><i class="fa fa-map-marker"></i> Ciwaruga, Ciletuh</span>
                                  <h4 className="mb-0 mt-1"><Link className="text-black" to={"./guest-detail"}>Curug Sodong</Link></h4>
                                </div>
                              </div>	
                            </td>
