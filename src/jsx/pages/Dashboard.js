...
import { getDashboard } from "../../services/OtherService";
		...
		getDashboard()
			.then((res) => {
				...
				setWidgetData({
					...
					totalArtikel: res.data.data.total.artikel,
					totalAcara: res.data.data.total.acara,
				});
			})
			.catch((err) => {
				console.log(err);
			...
			<div className="row">
					...
					<div className="card gradient-1 card-bx">
						<div className="card-body d-flex align-items-center">
							<div className="me-auto text-white">
								<h2 className="text-white">{widgetData.totalWisata}</h2>
				...
				<div className="col-xl-3 col-sm-6">
					<div className="card gradient-2 card-bx">
						<div className="card-body d-flex align-items-center">
							<div className="me-auto text-white">
								<h2 className="text-white">{widgetData.totalAcara}</h2>
				...
				<div className="col-xl-3 col-sm-6">
					<div className="card gradient-3 card-bx">
						<div className="card-body d-flex align-items-center">
							<div className="me-auto text-white">
								<h2 className="text-white">{widgetData.totalArtikel}</h2>
				...
				<div className="col-xl-3 col-sm-6">
					<div className="card gradient-4 card-bx">
						<div className="card-body d-flex align-items-center">
							<div className="me-auto text-white">
								<h2 className="text-white">{widgetData.totalKemitraan}</h2>
