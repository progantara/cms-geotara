...
const ThemeContextProvider = (props) => {
	...
	const [primaryColor, setPrimaryColor] = useState("color_9");
	const [navigationHader, setNavigationHader] = useState("color_9");
	const [haderColor, setHaderColor] = useState("color_9");
	...
	useEffect(() => {
		...
		body.setAttribute("data-headerbg", "color_9");
